...
export const HeaderBack: React.FC<{ placeholder: string; handleClick: () => void }> = ({
  placeholder,
  handleClick,
}) => {
  return (
...
export const HeaderDefault: React.FC<{ placeholder: string; handleClick: () => void }> = ({
  placeholder,
}) => {
  return (
    <div className="app-container-headerback">
    ...
    <div className="app-container-headerButton">
      <div className="app-container-header-default-title-button">
        ...
        <div className="app-container-header-default-button">
          <Button placeholder={nameButton} handleClick={handleClick} />
        </div>
      </div>
    </div>
  );
